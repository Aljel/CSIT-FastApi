...
async def trending(
    ...
    return await use_cases.get_trending(limit=limit)
...
async def similar(
    ...
    return await use_cases.get_similar(post_id, limit=limit, user_id=current_user.id)
...
async def personalized(
    ...
    return await use_cases.get_personalized(current_user.id, limit=limit)
